...
# load_path = '/home/lehu.sx/PDE_experiments/results/Obstacle_exp3_2/1221_1137/'
...
scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer,milestones=[5000,8000,10000], gamma=0.1)
