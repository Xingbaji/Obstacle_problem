...
# load_path = '/home/sx/PDE_experiments/results/Obstacle_V3/0125_2252/'
# load_path = '/home/sx/PDE_experiments/results/Obstacle_V3/0125_2336/'
# load_path = '/home/sx/PDE_experiments/results/Obstacle_V3/0126_0005/'
load_path = '/home/sx/PDE_experiments/results/Obstacle_V3/0126_1601/'
...
fig = plt.figure()
ax = plt.axes(projection='3d')
ax.plot_trisurf(input_inner[:,0],input_inner[:,1], U_inner_pred_np-U_exact_inner.squeeze(),cmap='viridis', edgecolor='none');
plt.show()
plt.close(fig)
...
delta_u_np = delta_u.cpu().detach().numpy().squeeze()
fig = plt.figure()
ax = plt.axes(projection='3d')
ax.plot_trisurf(input_inner[:,0],input_inner[:,1],delta_u_np[:,0],cmap='viridis', edgecolor='none');
plt.show()
plt.close(fig)
...
loss_1_flat_np_concact = loss_1_flat_np[contact_cond].squeeze()
...
fig = plt.figure()
ax = plt.axes(projection='3d')
ax.plot_trisurf(contact_x,contact_y, loss_1_flat_np_concact,cmap='viridis', edgecolor='none');
plt.show()
plt.close(fig)

#coincidence set
# coin_cond = np.abs(U_inner_pred_np - g_inner)<1e-3
# coin_x = input_inner[coin_cond][:,0]
# coin_y = input_inner[coin_cond][:,1]
# plt.plot(coin_x,coin_y,'.')
# plt.show()
# ax.set_title('loss_1')
...
#
# ax = plt.axes(projection='3d')
# ax.scatter(contact_x,contact_y, U_exact_contact - U_pred_contact);
# plt.show()
#
#
# diff = 1e-4
